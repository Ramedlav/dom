                                ...
                                @if($post->is_published)
                                    <div class="row" >
                                        <div class="col-12 col-sm-6" id="{{$post->id}}">
                                            ...
                                            <div class="">
                                                <div>
                                                    <label><b>{{__('price')}}:</b> </label> {{$post->price}} €.
                                                </div>
                                                <div>
                                                    <label><b>{{__('rooms')}}:</b> </label> {{$post->rooms}}
                                                </div>
                                                <div>
                                                    <label><b>{{__('bedrooms')}}:</b> </label> {{$post->bedrooms}}
                                                </div>
                                                <div>
                                                    <label><b>{{__('square')}}:</b> </label> {{$post->square}} м²
                                                </div>
                                                <div>
                                        ...
                                        <div class="wrapper">
                                            ...
                                            <div class="xpandable-block">
                                                <p>
                                                <b>{{__('Description')}} :</b>{!! $post->description !!}
                                                </p>
                                            </div>
                                        </div>
