<ul class="css-1ks0ui5">
	@foreach($out as $out_dialog)
		@php $pos=strpos(strtolower($out_dialog->address), strtolower($text_search)) || ($text_search == ''); @endphp
		<div class="css-1o8agjl {{ ($pos === false)?'d-none':'' }}" id="dialog_id_{{ $out_dialog->id }}">
			...
			<div>
				<a  href="post/{{$out_dialog->post_id }}" class="css-aogond">
					...
					<div class="css-164dfnt">
						<div class="css-1fulx0y address-search" dialog="dialog_id_{{ $out_dialog->id }}">
