...
<div class="container">
    <div class="row">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <button id="navbar-filter" class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarFilter" aria-controls="navbarFilter" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
        ...
        <div class="col-md-9">
                <div class="card-body" id="gridPosts">
                @include('gridPosts')
                </div>
        </div>
    </div>
