...
<div class="container">
    <div class="row">
		...
		<div class="container py-2 d-flex align-items-center">
			<h2 class="css-1q56cn">{{__('Feedback messages') }}</h2>
		</div>
                <div class="card-body">
                    @if (session('status'))
		...
		<div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            <label class="control-label d-flex align-items-center mb-1" for="filter_start_date">{{ __('From date') }}</label>
			    <input type="date" value="<?php echo date('Y-m-d') ?>" class="form-control" id="filter_start_date">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label class="control-label d-flex align-items-center mb-1" for="filter_finish_date">{{ __('To date') }}</label>
			    <input type="date" value="<?php echo date('Y-m-d') ?>" class="form-control" id="filter_finish_date">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
			    ...
			    <input type="text" value="" class="form-control" id="filter_name">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label class="control-label d-flex align-items-center mb-1" for="filter_email">{{ __('Email') }}</label>
			    <input type="text" value="" class="form-control" id="filter_email">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label class="control-label d-flex align-items-center mb-1" for="filter_message">{{ __('message') }}</label>
			    <input type="text" value="" class="form-control" id="filter_message">
                        </div>
                    </div>
                                    <div class="col-md-2 py-2 d-flex justify-content-center">
				        <div>
                                	        <button type="button" class="btn btn-default progress-button" title="{{ __('Search') }}" onclick="listmessages()">
                ...
                <div class="card-body">
			<div id="listmessages" class="py-2"></div>
		</div>
        </div>
    </div>
</div>
...
function clearFilter() {
        ...
        $('#filter_email').val('');
        $('#filter_message').val('');
        $('#filter_start_date').val('<?php echo date('Y-m-d'); ?>');
        $('#filter_finish_date').val('<?php echo date('Y-m-d'); ?>');
        listmessages();
    }
